  ...
  return (
    <div style={styles.container}>
            ...
            return (
              <div key={answer.id} style={styles.answerCard}>
                ...
                <div style={styles.evaluationSection}>
                  <h4 style={{ marginTop: 0, marginBottom: '15px' }}>Evaluation</h4>
                  ...
                  <div style={styles.formGroup}>
                    <label style={{ display: 'block', marginBottom: '5px', fontWeight: 'bold' }}>Score (Max: {question?.max_score || 1}):</label>
                    <input
                      type="number"
                      style={styles.input}
                      value={evaluation?.score_awarded !== undefined ? evaluation.score_awarded : ''}
                      onChange={(e) => {
                        const val = parseFloat(e.target.value);
                        handleEvaluate(answer.id, {
                          score_awarded: isNaN(val) ? 0 : val
                        });
                      }}
                      disabled={saving}
                    />
                  ...
                  <div style={styles.formGroup}>
                    <label style={{ display: 'block', marginBottom: '5px', fontWeight: 'bold' }}>Feedback:</label>
                    <textarea
      ...
      <div style={{ marginTop: '30px', display: 'flex', justifyContent: 'space-between' }}>
        <Button onClick={() => navigate(-1)} style={{ backgroundColor: 'transparent', border: '2px solid #000000' }}>Back to Attempts</Button>
        <Button
